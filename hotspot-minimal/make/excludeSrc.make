...
CXXFLAGS := $(filter-out -DCOMPILER1 -DCOMPILER2,$(CXXFLAGS))
CFLAGS := $(filter-out -DCOMPILER1 -DCOMPILER2,$(CFLAGS))
...
TYPE=COMPILER1
CXXFLAGS += -DMINIMAL_JVM -DCOMPILER1 -DVMTYPE=\"Minimal\" -fPIC
CFLAGS += -DMINIMAL_JVM -DCOMPILER1 -DVMTYPE=\"Minimal\" -fPIC
